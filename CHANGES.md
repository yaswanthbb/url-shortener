...
- Used an **dictionary** to store short codes and associated metadata.
- Added concurrency-safe access using `threading.Lock` to avoid race conditions.
- Created utility functions for Validating URLs and Generating unique 6-character short codes
